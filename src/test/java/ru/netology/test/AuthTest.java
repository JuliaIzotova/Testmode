...
class AuthTest {
    ...
    // попытка для себя написать на xpath
//        $x("//span[@data-test-id='login']//child::input").setValue(registeredUser.getLogin());
//        $x("//span[@data-test-id='password']//child::input").setValue(registeredUser.getPassword());
//        $x("//button").click();
